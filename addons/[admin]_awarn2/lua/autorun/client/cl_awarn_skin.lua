...
SKIN.listview_hover				= Color( 250, 70, 70, 255 )
SKIN.listview_selected			= Color( 250, 170, 220, 255 )
...
function SKIN:PaintListViewLine( panel, w, h )
	...
	if ( panel:IsSelected() ) then
		surface.SetDrawColor( Color( 160, 160, 210, 200 ) )
		surface.DrawRect( 0, 0, w, h )
		surface.SetDrawColor( Color( 200, 200, 200, 200 ) )
		surface.DrawOutlinedRect( 0, 0, w, h )
	elseif ( panel.Hovered ) then
		surface.SetDrawColor( Color( 160, 160, 160, 200 ) )
		surface.DrawRect( 0, 0, w, h )
		surface.SetDrawColor( Color( 160, 160, 160, 200 ) )
		surface.DrawOutlinedRect( 0, 0, w, h )
	elseif ( panel.m_bAlt ) then
		surface.SetDrawColor( Color( 180, 180, 180, 80 ) )
		surface.DrawRect( 0, 0, w, h )
	else		
		surface.SetDrawColor( Color( 160, 160, 160, 80 ) )
		surface.DrawRect( 0, 0, w, h )
	end
...
derma.DefineSkin( "AWarn", "Made for AWarn2", SKIN )
