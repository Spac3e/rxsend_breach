...
CustomizableWeaponry.colorableParts.colorText = {[CustomizableWeaponry.colorableParts.COLOR_TYPE_SIGHT] = " (HOLD - 更改十字线颜色)",
	[CustomizableWeaponry.colorableParts.COLOR_TYPE_BEAM] = " (HOLD - 更改光束颜色)"}
