...
if CLIENT then
	...
	SWEP.InvIcon = Material( "nextoren/gui/icons/weapons/dvl10.png" )
	...
	SWEP.KKINS2ScopeMosinPos = Vector(-2.81, 1.809, -1.005)
	SWEP.KKINS2ScopeMosinAng = Vector()

	SWEP.IronsightPos = Vector(-2.81, 1.809, -0.55)
	SWEP.IronsightAng = Vector(-0.03, 0.03, 0)

	SWEP.KKINS2KobraPos = Vector(-2.81, 1.809, -0.55)
	SWEP.KKINS2KobraAng = Vector()

	SWEP.KKINS2EoTechPos = Vector(-2.81, 1.809, -0.3)
	SWEP.KKINS2EoTechAng = Vector()

	SWEP.KKINS2AimpointPos = Vector(-2.81, 1.809, -0.4)
	SWEP.KKINS2AimpointAng = Vector()

	SWEP.KKINS2ElcanPos = Vector(-2.81, 1.809, -0.5)
	SWEP.KKINS2ElcanAng = Vector()

	SWEP.KKINS2PO4Pos = Vector(-2.81, 1.809, -0.2)
	SWEP.KKINS2PO4Ang = Vector()

	SWEP.KKINS2ScopeM40Pos = Vector(-2.81, 1.809, 0.05)
	SWEP.KKINS2ScopeM40Ang = Vector()

	SWEP.KKINS2MagnifierPos = Vector(-2.81, 1.809, -0.3)
...
SWEP.ViewModel		= "models/weapons/cw_cultist/dvl10/v_dvl10.mdl"
SWEP.WorldModel		= "models/weapons/cw_cultist/dvl10/w_dvl10.mdl"
...
SWEP.FireDelay = 0.3
SWEP.FireSound = "CW_KK_INS2_DVL10_FIRE"
SWEP.FireSoundSuppressed = "CW_KK_INS2_DVL10_FIRE_SUPPRESSED"
SWEP.Recoil = 2.5
