...
if ( CLIENT ) then
	...
	SWEP.AttachmentModelsVM = {
		["kk_ins2_optic_iron"] = {model = "models/weapons/cw_cultist/m4a1_tech/upgrades/a_carryhandle_m4.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, active = true},
...
SWEP.ViewModel		= "models/weapons/cw_cultist/m4a1_tech/v_m4a1_tech.mdl"
SWEP.WorldModel		= "models/weapons/cw_cultist/m4a1_tech/w_m4a1_tech.mdl"
