...
if CLIENT then
	...
	SWEP.InvIcon = Material( "nextoren/gui/icons/weapons/minimi.png" )
...
SWEP.ViewModel		= "models/weapons/cw_cultist/minimi/v_minimi.mdl"
SWEP.WorldModel		= "models/weapons/cw_cultist/minimi/w_minimi.mdl"
...
SWEP.Primary.DefaultClip = 0 --	= 200
SWEP.Primary.Automatic		= true
SWEP.Primary.Ammo			= "GOC"

SWEP.FireDelay = 45/550
