--[[
lua/weapons/cw_kk_ins2_nade_m84/shared.lua
--]]
...
if CLIENT then
	...
	SWEP.SelectIcon = surface.GetTextureID("vgui/entities/m84")

	SWEP.InvIcon = Material( "nextoren/gui/icons/weapons/m84_nade.png" )
