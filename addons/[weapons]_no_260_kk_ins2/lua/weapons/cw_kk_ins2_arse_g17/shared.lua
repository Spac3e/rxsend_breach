--[[
lua/weapons/cw_kk_ins2_arse_g17/shared.lua
--]]
...
if CLIENT then
	...
	SWEP.InvIcon = Material( "nextoren/gui/icons/weapons/glock17.png" )

	SWEP.SelectIcon = surface.GetTextureID("vgui/entities/g17")
