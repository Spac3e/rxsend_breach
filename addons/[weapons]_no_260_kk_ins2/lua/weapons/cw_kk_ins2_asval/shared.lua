...
if CLIENT then
	...
	SWEP.InvIcon = Material( "nextoren/gui/icons/weapons/asval.png" )
...
SWEP.ViewModel		= "models/weapons/cw_cultist/asval/v_asval.mdl"
SWEP.WorldModel		= "models/weapons/cw_cultist/asval/w_asval.mdl"
...
SWEP.FireDelay = 0.08
SWEP.FireSound = "CW_KK_INS2_ASVAL_FIRE"
SWEP.FireSoundSuppressed = "CW_KK_INS2_ASVAL_FIRE_SUPPRESSED"
SWEP.Recoil = 1.42
