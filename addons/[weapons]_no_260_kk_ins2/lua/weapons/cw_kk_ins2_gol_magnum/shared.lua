...
if CLIENT then
	...
	SWEP.AttachmentModelsVM = {
		["kk_ins2_optic_iron"] = {model = "models/weapons/cw_cultist/golmagnum/upgrades/a_standard_m40.mdl", pos = Vector(), angle = Angle(90, 90, 0), size = Vector(1, 1, 1), merge = true, active = true},
...
SWEP.ViewModel		= "models/weapons/cw_cultist/golmagnum/v_golmagnum.mdl"
SWEP.WorldModel		= "models/weapons/cw_cultist/golmagnum/w_golmagnum.mdl"
...
SWEP.FireDelay = 0.3
SWEP.FireSound = "CW_KK_INS2_GOL_FIRE"
