...
if CLIENT then
	...
	SWEP.PrintName = "RPK74"
	SWEP.CSMuzzleFlashes = true
	SWEP.ViewModelMovementScale = 1.15
	SWEP.InvIcon = Material( "nextoren/gui/icons/weapons/rpk.png" )
...
SWEP.ViewModel		= "models/weapons/cw_cultist/rpk74/v_rpk74.mdl"
SWEP.WorldModel		= "models/weapons/cw_cultist/rpk74/_rpk74.mdl"
