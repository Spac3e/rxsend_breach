...
if CLIENT then
	...
	SWEP.InvIcon = Material( "nextoren/gui/icons/weapons/sr25.png" )
	...
	SWEP.AttachmentModelsVM = {
		...
		["kk_ins2_vertgrip"] = {model = "models/weapons/cw_cultist/sr25/upgrades/a_foregrip_sec2.mdl", pos = Vector(), angle = Angle(0, 90, 0), size = Vector(0.5, 0.5, 0.5), attachment = "Foregrip"},
...
SWEP.ViewModel		= "models/weapons/cw_cultist/sr25/v_sr25.mdl"
SWEP.WorldModel		= "models/weapons/cw_cultist/sr25/w_sr25.mdl"
...
SWEP.FireSound = "CW_KK_INS2_SR25_FIRE"
SWEP.FireSoundSuppressed = "CW_KK_INS2_SR25_FIRE_SUPPRESSED"
SWEP.Recoil = 1.6
