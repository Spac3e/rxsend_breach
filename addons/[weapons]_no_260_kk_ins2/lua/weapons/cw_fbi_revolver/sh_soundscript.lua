...
SWEP.Sounds = {
	base_ready = {
		...
		{time = 12/28, sound = "CW_KK_INS2_REVOLVER_OPENCHAMBER"},
		{time = 21/28, sound = "CW_KK_INS2_REVOLVER_CLOSECHAMBER"},
		{time = 31/28, sound = "CW_KK_INS2_UNIVERSAL_LEANIN"},
		{time = 36/28, sound = "CW_KK_INS2_REVOLVER_SPIN" }
	},
	...
	base_reload_start = {
		...
		{time = 21/33.5, sound = "CW_KK_INS2_REVOLVER_OPENCHAMBER"},
		{time = 30/33.5, sound = "CW_KK_INS2_REVOLVER_DUMPROUNDS"},
	...
	base_reload_end = {
		{time = 8/34.5, sound = "CW_KK_INS2_UNIVERSAL_LEANOUT"},
		{time = 25/34.5, sound = "CW_KK_INS2_REVOLVER_CLOSECHAMBER"},
	},
	...
	base_reload_speed = {
		...
		{time = 62/33.5, sound = "CW_KK_INS2_REVOLVER_SPEEDLOADERINSERT"},
		{time = 87/33.5, sound = "CW_KK_INS2_REVOLVER_CLOSECHAMBER"},
		{time = 102/33.5, sound = "CW_KK_INS2_REVOLVER_SPIN"},
	},
