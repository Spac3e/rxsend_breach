...
if CLIENT then
	...
	SWEP.InvIcon = Material( "nextoren/gui/icons/weapons/fbi_revolver.png" )
	...
	SWEP.IronsightPos = Vector(-2.7, 0, 0)
...
SWEP.ViewModel		= "models/cultist/humans/fbi/weapons/revolver/v_38rev.mdl"
SWEP.WorldModel		= "models/cultist/humans/fbi/weapons/revolver/w_38rev.mdl"
