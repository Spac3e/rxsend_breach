...
if CLIENT then
	...
	SWEP.PrintName = "MK14 EBR"
	SWEP.CSMuzzleFlashes = true
	SWEP.ViewModelMovementScale = 1.15
	SWEP.InvIcon = Material( "nextoren/gui/icons/weapons/mk14.png" )
...
SWEP.ViewModel		= "models/weapons/cw_cultist/mk14/v_mk14.mdl"
SWEP.WorldModel		= "models/weapons/cw_cultist/mk14/w_mk14.mdl"
