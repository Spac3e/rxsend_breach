...
if CLIENT then
	...
	SWEP.InvIcon = Material( "nextoren/gui/icons/weapons/svd.png" )
	...
	SWEP.IronsightPos = Vector(-2.04, 0, 0.6)
	SWEP.IronsightAng = Vector()

	SWEP.KKINS2EoTechPos = Vector(-2.04, 0, -0.3)
	SWEP.KKINS2EoTechAng = Vector()

	SWEP.KKINS2KobraPos = Vector(-2.04, 0, -0.3)
	SWEP.KKINS2KobraAng = Vector()

	SWEP.KKINS2AimpointPos = Vector(-2.04, 0, -0.3)
	SWEP.KKINS2AimpointAng = Vector()

	SWEP.KKINS2ElcanPos = Vector(-2.04, 0, -0.35)
	SWEP.KKINS2ElcanAng = Vector()

	SWEP.KKINS2PO4Pos = Vector(-2.04, 0, -0.35)
	SWEP.KKINS2PO4Ang = Vector()

	SWEP.KKINS2ScopeMosinPos = Vector(-2.04, 0, -0.35)
	SWEP.KKINS2ScopeMosinAng = Vector()

	SWEP.KKINS2MagnifierPos = Vector(-2.04, 0, -0.3)
	SWEP.KKINS2MagnifierAng = Vector()

	SWEP.KKINS2CSTMCMorePos =  Vector(-2.04, 0, -0.35)
	SWEP.KKINS2CSTMCMoreAng = Vector()

	SWEP.KKINS2CSTMBarskaPos =  Vector(-2.04, 0, -0.35)
	...
	SWEP.KKINS2CSTMACOGPos =  Vector(-2.04, 0, -0.35)
	SWEP.KKINS2CSTMACOGAng = Vector()

	SWEP.CustomizationMenuScale = 0.017
end

SWEP.MuzzleEffect = "muzzleflash_SVD_1p_core"
SWEP.MuzzleEffectWorld = "muzzleflash_SVD_3rd"
...
SWEP.ViewModel		= "models/weapons/cw_cultist/svd/v_svd.mdl"
SWEP.WorldModel		= "models/weapons/cw_cultist/svd/w_svd.mdl"
