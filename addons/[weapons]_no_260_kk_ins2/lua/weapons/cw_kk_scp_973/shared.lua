...
if CLIENT then
	...
	SWEP.ShellDelay = 0
	SWEP.NoShells = true
	SWEP.InvIcon = Material( "nextoren/gui/icons/weapons/toz.png" )
...
SWEP.ViewModel		= "models/cultist/scp/scp_973/weapons/v_shotgun.mdl"
SWEP.WorldModel		= "models/cultist/scp/scp_973/weapons/w_shotgun.mdl"

SWEP.WMPos = Vector( 5.314, 0.759, -2 )
...
SWEP.DeployTime = 0.7
SWEP.DisableFireModeSwitch = true
