...
if CLIENT then
	...
	SWEP.InvIcon = Material( "nextoren/gui/icons/weapons/ak12.png" )
	...
	SWEP.AttachmentModelsVM = {
		...
		["kk_ins2_vertgrip"] = {model = "models/weapons/cw_cultist/ak12/upgrades/a_woodgrips_ak74.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},
	...
	SWEP.AttachmentModelsWM = {
		...
		["kk_ins2_vertgrip"] = {model = "models/weapons/cw_cultist/ak12/weapons/upgrades/w_foregrip_wood_2.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},
	...
	SWEP.IronsightPos = Vector(-2.83, -3, 0.4 )
...
SWEP.ViewModel		= "models/weapons/cw_cultist/ak12/v_ak12.mdl"
SWEP.WorldModel		= "models/weapons/cw_cultist/ak12/w_ak12.mdl"
