...
if CLIENT then
	...
	SWEP.InvIcon = Material( "nextoren/gui/icons/weapons/br99.png" )
...
SWEP.MuzzleEffectWorld = "muzzleflash_shotgun_npc"
...
SWEP.Attachments = {
	...
	{header = "Lasers", offset = {125, 400}, atts = {"kk_ins2_flashlight"}},
