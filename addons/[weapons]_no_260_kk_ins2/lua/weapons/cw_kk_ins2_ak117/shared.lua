...
if CLIENT then
	...
	SWEP.PrintName = "AK-117"
	SWEP.CSMuzzleFlashes = true
	SWEP.InvIcon = Material( "nextoren/gui/icons/weapons/ak117.png" )
	...
	SWEP.AttachmentModelsVM = {
		...
		["kk_ins2_vertgrip"] = {model = "weapons/cw_cultist/ak117/upgrades/a_woodgrips_ak74.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},
	...
	SWEP.AttachmentModelsWM = {
		...
		["kk_ins2_vertgrip"] = {model = "weapons/cw_cultist/ak117/upgrades/w_foregrip_wood_2.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},
...
SWEP.ViewModel		= "models/weapons/cw_cultist/ak117/v_ak117.mdl"
SWEP.WorldModel		= "models/weapons/cw_cultist/ak117/w_ak117.mdl"
