--[[
lua/weapons/cw_kk_ins2_arse_m1014/sh_soundscript.lua
--]]
...
SWEP.Sounds = {
	...
	base_ready = {
		{time = 0, sound = "CW_KK_INS2_UNIVERSAL_DRAW"},
		{time = 24/30, sound = "CW_KK_INS2_M590_PUMPFORWARD"},
	...
	base_reload_start_empty = {
		...
		{time = 29/35, sound = "CW_KK_INS2_M590_PUMPBACK"},
		{time = 32/35, sound = "", callback = shell},
		{time = 46/35, sound = "CW_KK_INS2_M590_SHELLINSERTSINGLE"},
		{time = 62/35, sound = "CW_KK_INS2_M590_PUMPFORWARD"},
		{time = 76/35, sound = "CW_KK_INS2_UNIVERSAL_LEANIN"},
