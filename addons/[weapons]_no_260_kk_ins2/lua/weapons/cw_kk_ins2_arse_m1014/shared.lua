--[[
lua/weapons/cw_kk_ins2_arse_m1014/shared.lua
--]]
...
if CLIENT then
	SWEP.InvIcon = Material( "nextoren/gui/icons/weapons/m1014.png", "noclamp smooth" )
...
if CLIENT then
	...
	SWEP.SelectIcon = surface.GetTextureID("vgui/entities/m1014")

	SWEP.NoShells = true
	SWEP.Shell = "KK_INS2_12guage"

	SWEP.Viewmodel_OffsetBones = {
		[93] = Vector(0, 8, 0),
		[46] = Vector(0, 8, 0),
	}
	...
	SWEP.IronsightPos = Vector(-3.055, -2, 1.2)
	SWEP.IronsightAng = Vector()

	SWEP.M203Pos = Vector(-3.055, -2, 1.2)
	SWEP.M203Ang = Vector()

	SWEP.KKINS2KobraPos = Vector(-3.055, -2, 0.25)
	SWEP.KKINS2KobraAng = Vector()

	SWEP.KKINS2EoTechPos = Vector(-3.055, -2, 0.25)
	SWEP.KKINS2EoTechAng = Vector()

	SWEP.KKINS2AimpointPos = Vector(-3.055, -2, 0.25)
	SWEP.KKINS2AimpointAng = Vector()

	SWEP.KKINS2PO4Pos = Vector(-3.055, -2, 0.25)
	SWEP.KKINS2PO4Ang = Vector()

	SWEP.KKINS2ElcanPos = Vector(-3.055, -2, 0.25)
	SWEP.KKINS2ElcanAng = Vector()

	SWEP.KKINS2MagnifierPos = Vector(-3.05, -2, 0.325)
	SWEP.KKINS2MagnifierAng = Vector()

	SWEP.KKINS2CSTMMicroT1Pos = Vector(-3.055, -2, 0.25)
	SWEP.KKINS2CSTMMicroT1Ang = Vector()

	SWEP.KKINS2CSTMPGO7Pos = Vector(-3.055, -2, 0.25)
	SWEP.KKINS2CSTMPGO7Ang = Vector()

	SWEP.KKINS2CSTMACOGPos = Vector(-3.055, -2, 0.25)
...
SWEP.ReloadTimes = {
	...
	base_reload_start_empty = {3.25, 3.15, KK_INS2_SHOTGUN_LOAD_FIRST},
	base_reload_insert = {15/36, 0.8},
