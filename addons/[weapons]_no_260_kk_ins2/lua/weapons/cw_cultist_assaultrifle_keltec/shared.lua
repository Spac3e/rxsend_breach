...
if CLIENT then
	...
	SWEP.PrintName = "KelTec"
	SWEP.CSMuzzleFlashes = true
	SWEP.InvIcon = Material( "nextoren/gui/icons/weapons/keltec.png" )
	...
	SWEP.AttachmentModelsVM = {
		...
		["kk_ins2_mag_l1a1_20"] = {model = "models/weapons/cw_cultist/keltec/upgrades/a_magazine_keltec_20.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, active = true},
...
SWEP.ViewModel		= "models/weapons/cw_cultist/keltec/v_keltec.mdl"
SWEP.WorldModel		= "models/weapons/cw_cultist/keltec/w_keltec.mdl"
...
SWEP.FireSound = "CW_KK_INS2_KELTEC_FIRE"
SWEP.FireSoundSuppressed = "CW_KK_INS2_KELTEC_FIRE_SUPPRESSED"
SWEP.Recoil = 1.5
