--[[
lua/weapons/cw_kk_ins2_ak74/shared.lua
--]]
...
if CLIENT then
	...
	SWEP.SelectIcon = surface.GetTextureID("vgui/entities/ak74")
	SWEP.InvIcon = Material( "nextoren/gui/icons/weapons/ak74.png", "noclamp smooth" )
