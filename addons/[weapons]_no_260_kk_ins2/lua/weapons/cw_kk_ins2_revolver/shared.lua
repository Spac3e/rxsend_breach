--[[
lua/weapons/cw_kk_ins2_revolver/shared.lua
--]]
...
if CLIENT then
	...
	SWEP.InvIcon = Material( "nextoren/gui/icons/weapons/38revolver.png" )

	SWEP.SelectIcon = surface.GetTextureID("vgui/entities/revoler")
