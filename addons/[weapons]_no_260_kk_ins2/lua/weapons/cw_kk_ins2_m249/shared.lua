--[[
lua/weapons/cw_kk_ins2_m249/shared.lua
--]]
...
if CLIENT then
	...
	SWEP.InvIcon = Material( "nextoren/gui/icons/weapons/m249.png" )

	SWEP.SelectIcon = surface.GetTextureID("vgui/entities/m249")
