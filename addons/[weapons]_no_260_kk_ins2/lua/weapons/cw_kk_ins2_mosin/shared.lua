--[[
lua/weapons/cw_kk_ins2_mosin/shared.lua
--]]
...
if CLIENT then
	...
	SWEP.InvIcon = Material( "nextoren/gui/icons/weapons/mosin.png" )

	SWEP.SelectIcon = surface.GetTextureID("vgui/entities/mosin")
