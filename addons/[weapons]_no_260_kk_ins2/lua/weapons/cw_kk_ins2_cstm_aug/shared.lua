--[[
lua/weapons/cw_kk_ins2_cstm_aug/shared.lua
--]]
...
if CLIENT then
	...
	SWEP.InvIcon = Material( "nextoren/gui/icons/weapons/aug.png", "noclamp smooth" )
	...
	SWEP.AttachmentModelsWM = {
		...
		["kk_ins2_suppressor_sec"] = {model = "models/weapons/upgrades/w_sil_ins1.mdl", pos = Vector(5, 0, 0), angle = Angle(), size = Vector(1, 1, 1), merge = true},
