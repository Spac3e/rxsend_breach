...
if CLIENT then
	...
	SWEP.PrintName = "AKS-74U Modern"
	SWEP.CSMuzzleFlashes = true
	SWEP.InvIcon = Material( "nextoren/gui/icons/weapons/ak74_modern.png" )
	...
	SWEP.AttachmentModelsVM = {
		...
		["kk_ins2_vertgrip"] = {model = "models/weapons/cw_cultist/aks74_modern/upgrades/a_woodgrips_aks74u.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},
	...
	SWEP.AttachmentModelsWM = {
		...
		["kk_ins2_vertgrip"] = {model = "models/weapons/cw_cultist/aks74_modern/upgrades/w_foregrip_aks74u.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},
...
SWEP.ViewModel		= "models/weapons/cw_cultist/aks74_modern/v_aks74_modern.mdl"
SWEP.WorldModel		= "models/weapons/cw_cultist/aks74_modern/w_aks74_modern.mdl"
