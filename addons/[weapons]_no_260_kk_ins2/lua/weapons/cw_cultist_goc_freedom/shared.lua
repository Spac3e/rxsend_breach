...
if CLIENT then
	...
	SWEP.PrintName = "Freedom"
	SWEP.CSMuzzleFlashes = true
	SWEP.ViewModelMovementScale = 1.15
	SWEP.InvIcon = Material( "nextoren/gui/icons/weapons/freedom.png" )
	...
	SWEP.AttachmentModelsVM = {
		["kk_ins2_optic_iron"] = {model = "models/weapons/cw_cultist/freedom/upgrades/a_standard_mk18.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, active = true},

		["cover_long"] = {model = "models/weapons/cw_cultist/freedom/upgrades/a_standard2_mk18.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, active = true},
		["cover_short"] = {model = "models/weapons/cw_cultist/freedom/upgrades/a_standard3_mk18.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},
	...
	SWEP.IronsightPos = Vector( -2.9, -4.3, 1 )
...
SWEP.ViewModel		= "models/weapons/cw_cultist/freedom/v_freedom.mdl"
SWEP.WorldModel		= "models/weapons/cw_cultist/freedom/w_freedom.mdl"

SWEP.WMPos = Vector( 4, 0.711, -0.743)
...
SWEP.FireSound = "CW_KK_INS2_FREEDOM_FIRE"
SWEP.FireSoundSuppressed = "CW_KK_INS2_FREEDOM_FIRE_SUPPRESSED"
SWEP.Recoil = 1.1025
