...
if CLIENT then
	...
	SWEP.PrintName = "M84 Barrett"
	SWEP.CSMuzzleFlashes = true
	SWEP.ViewModelMovementScale = 1.15
	SWEP.InvIcon = Material( "nextoren/gui/icons/weapons/barrett.png" )
...
SWEP.ViewModel		= "models/weapons/cw_cultist/barrett/v_barrett.mdl"
SWEP.WorldModel		= "models/weapons/cw_cultist/barrett/w_barrett.mdl"
