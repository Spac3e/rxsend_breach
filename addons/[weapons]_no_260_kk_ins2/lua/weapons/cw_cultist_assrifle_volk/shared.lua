...
if CLIENT then
	...
	SWEP.InvIcon = Material( "nextoren/gui/icons/weapons/volk.png" )
	...
	SWEP.AttachmentModelsVM = {
		...
		["kk_ins2_vertgrip"] = {model = "models/weapons/cw_cultist/volk/upgrades/a_woodgrips_akm.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},
	...
	SWEP.KKINS2KobraPos = Vector(-2.3112, -2, -0.8 )
...
SWEP.ViewModel		= "models/weapons/cw_cultist/volk/v_volk.mdl"
SWEP.WorldModel		= "models/weapons/cw_cultist/volk/w_volk.mdl"
