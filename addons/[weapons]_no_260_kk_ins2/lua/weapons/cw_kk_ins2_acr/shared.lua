...
if CLIENT then
	...
	SWEP.InvIcon = Material( "nextoren/gui/icons/weapons/acr.png" )
	...
	SWEP.AttachmentModelsVM = {
		["kk_ins2_optic_iron"] = {model = "models/weapons/cw_cultist/upgrades/a_standard_mk18.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, active = true},
	...
	SWEP.AttachmentModelsWM = {
		["kk_ins2_optic_iron"] = {model = "models/weapons/cw_cultist/upgrades/w_flipup2.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, active = true},
	...
	SWEP.IronsightPos = Vector(-2.814, -0.603, 1.004)
	SWEP.IronsightAng = Vector()

	SWEP.KKINS2KobraPos = Vector(-2.8, -2, 0)
	SWEP.KKINS2KobraAng = Vector()

	SWEP.KKINS2EoTechPos = Vector(-2.8, -1.5, -0.2)
	SWEP.KKINS2EoTechAng = Vector()

	SWEP.KKINS2AimpointPos = Vector(-2.8, -1.5, 0)
	SWEP.KKINS2AimpointAng = Vector()

	SWEP.KKINS2ElcanPos = Vector(-2.8, -1.5, -0.2)
	SWEP.KKINS2ElcanAng = Vector()

	SWEP.KKINS2PO4Pos = Vector(-2.8, -1.5, -0.2)
	SWEP.KKINS2PO4Ang = Vector()

	SWEP.KKINS2MagnifierPos = Vector(-2.8, -1.5, 0)
	SWEP.KKINS2MagnifierAng = Vector()

	SWEP.KKINS2CSTMEoTechXPSPos = Vector(-2.8, -2, 0)
...
SWEP.ViewModel		= "models/weapons/cw_cultist/acr/v_acr.mdl"
SWEP.WorldModel		= "models/weapons/cw_cultist/acr/w_acr.mdl"
