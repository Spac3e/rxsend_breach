...
if CLIENT then
	...
	SWEP.InvIcon = Material( "nextoren/gui/icons/weapons/m23.png" )
	...
	SWEP.AttachmentModelsVM = {
		["kk_ins2_optic_iron"] = {model = "models/weapons/cw_cultist/m200/upgrades/a_standard_m40.mdl", pos = Vector(), angle = Angle(90, 90, 0), size = Vector(1, 1, 1), merge = true, active = true},
		...
		["kk_ins2_bipod"] = {model = "models/weapons/cw_cultist/m200/upgrades/a_bipod_m40.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},
		...
		["kk_ins2_scope_m40"] = {model = "models/weapons/cw_cultist/m200/upgrades/a_optic_m40.mdl", rLight = true, pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},
	...
	SWEP.AttachmentModelsWM = {
		...
		["kk_ins2_scope_m40"] = {model = "models/weapons/cw_cultist/m200/upgrades/w_scope_m40.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},
...
SWEP.ViewModel		= "models/weapons/cw_cultist/m200/v_m200.mdl"
SWEP.WorldModel		= "models/weapons/cw_cultist/m200/w_m200.mdl"
