--[[
lua/weapons/cw_kk_ins2_mk18/shared.lua
--]]
...
if CLIENT then
	...
	SWEP.InvIcon = Material( "nextoren/gui/icons/weapons/mk18.png" )

	SWEP.SelectIcon = surface.GetTextureID("vgui/entities/mk18")
