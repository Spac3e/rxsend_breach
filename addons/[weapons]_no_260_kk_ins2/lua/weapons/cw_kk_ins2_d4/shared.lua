...
if CLIENT then
	...
	SWEP.InvIcon = Material( "nextoren/gui/icons/weapons/d4.png" )
	...
	SWEP.AttachmentModelsVM = {
		["kk_ins2_optic_iron"] = {model = "models/weapons/cw_cultist/d4/upgrades/a_standard_mk18.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, active = true},

		["cover_long"] = {model = "models/weapons/cw_cultist/d4/upgrades/a_standard2_mk18.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, active = true},
	...
	SWEP.AttachmentModelsWM = {
		["kk_ins2_optic_iron"] = {model = "models/weapons/cw_cultist/d4/upgrades/w_flipup2.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, active = true},
...
SWEP.ViewModel		= "models/weapons/cw_cultist/d4/v_d4.mdl"
SWEP.WorldModel		= "models/weapons/cw_cultist/d4/w_d4.mdl"
...
SWEP.FireSound = "CW_KK_INS2_D4_FIRE"
SWEP.FireSoundSuppressed = "CW_KK_INS2_D4_FIRE_SUPPRESSED"
SWEP.Recoil = 1.1025
