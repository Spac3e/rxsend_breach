...
if CLIENT then
	...
	SWEP.InvIcon = Material( "nextoren/gui/icons/weapons/vss.png" )
...
SWEP.ViewModel		= "models/weapons/cw_cultist/vss/v_vss.mdl"
SWEP.WorldModel		= "models/weapons/cw_cultist/vss/w_vss.mdl"
...
SWEP.FireSound = "CW_KK_INS2_VSS_FIRE"
SWEP.FireSoundSuppressed = "CW_KK_INS2_VSS_FIRE_SUPPRESSED"
SWEP.Recoil = 1.15
