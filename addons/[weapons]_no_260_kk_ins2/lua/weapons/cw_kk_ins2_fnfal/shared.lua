--[[
lua/weapons/cw_kk_ins2_fnfal/shared.lua
--]]
...
if CLIENT then
	...
	SWEP.InvIcon = Material( "nextoren/gui/icons/weapons/fal.png" )

	SWEP.SelectIcon = surface.GetTextureID("vgui/entities/fnfal")
