...
if CLIENT then
	...
	SWEP.PrintName = "Ithaca37"
	SWEP.CSMuzzleFlashes = true
	SWEP.ViewModelMovementScale = 1.15
	SWEP.InvIcon = Material( "nextoren/gui/icons/weapons/ithaca37.png" )
...
SWEP.ViewModel		= "models/weapons/cw_cultist/ithaca37/v_ithaca37.mdl"
SWEP.WorldModel		= "models/weapons/cw_cultist/ithaca37/w_ithaca37.mdl"
