--[[
lua/weapons/cw_kk_ins2_makarov/shared.lua
--]]
...
if CLIENT then
	...
	SWEP.InvIcon = Material( "nextoren/gui/icons/weapons/makarov.png" )

	SWEP.SelectIcon = surface.GetTextureID("vgui/entities/makarov")
