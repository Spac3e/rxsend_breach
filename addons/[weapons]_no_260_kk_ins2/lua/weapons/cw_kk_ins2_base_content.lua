...
--1.0
	CustomizableWeaponry:registerAmmo("Sniper", "Sniper Rounds", 7.62, 63.3)
	CustomizableWeaponry:registerAmmo("SCP062Ammo", "SCP062Ammo Rounds", 7.62, 63.3)
	CustomizableWeaponry:registerAmmo("GRU", "GRU Rounds", 7.62, 63.3)
	CustomizableWeaponry:registerAmmo("GOC", "GOC Rounds", 7.62, 63.3)
	CustomizableWeaponry:registerAmmo("Revolver", "Revolver", 9.07, 0)
	CustomizableWeaponry:registerAmmo("Shotgun", "Shotgun", .410, 0)
end
// FIREMODES
do
