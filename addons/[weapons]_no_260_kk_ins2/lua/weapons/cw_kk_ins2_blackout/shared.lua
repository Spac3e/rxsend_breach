...
if CLIENT then
	...
	SWEP.PrintName = "Blackout"
	SWEP.CSMuzzleFlashes = true
	SWEP.ViewModelMovementScale = 1.15
	SWEP.InvIcon = Material( "nextoren/gui/icons/weapons/blackout.png" )
	...
	SWEP.AttachmentModelsVM = {
		["kk_ins2_optic_iron"] = {model = "models/weapons/cw_cultist/blackout/upgrades/a_carryhandle_m4.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, active = true},
	...
	SWEP.AttachmentModelsWM = {
		["kk_ins2_optic_iron"] = {model = "models/weapons/cw_cultist/blackout/upgrades/w_flipup3.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, active = true},
	...
	SWEP.IronsightPos = Vector( -2.8, -2, 0 )
	SWEP.IronsightAng = Vector( 0, 0, 0)

	SWEP.FoldSightPos = Vector( -2.8, -2, 0.1 )
	SWEP.FoldSightAng = Vector( 0, 0, 0)

	SWEP.M203Pos = Vector(-0.5168, -2, 1.149)
	SWEP.M203Ang = Vector(0.593, -0.0025, 0)

	SWEP.KKINS2KobraPos = Vector( -2.8, -2, -0.3 )
	SWEP.KKINS2KobraAng = Vector()

	SWEP.KKINS2EoTechPos = Vector( -2.8, -2, -0.28 )
	SWEP.KKINS2EoTechAng = Vector()

	SWEP.KKINS2AimpointPos = Vector( -2.8, -2, -0.25 )
	SWEP.KKINS2AimpointAng = Vector()

	SWEP.KKINS2ElcanPos = Vector( -2.8, -3, -0.3 )
	SWEP.KKINS2ElcanAng = Vector()

	SWEP.KKINS2PO4Pos = Vector( -2.75, -2, 0 )
	SWEP.KKINS2PO4Ang = Vector()

	SWEP.KKINS2MagnifierPos = Vector( -2.9, -1, -0.4 )
	SWEP.KKINS2MagnifierAng = Vector()

	SWEP.KKINS2CSTMCMorePos = Vector( -2.8, -2, -0.2 )
	SWEP.KKINS2CSTMCMoreAng = Vector()

	SWEP.KKINS2CSTMBarskaPos = Vector( -2.8, -2, -0.2 )
	SWEP.KKINS2CSTMBarskaAng = Vector()

	SWEP.KKINS2CSTMMicroT1Pos = Vector( -2.8, -2, -0.2 )
	SWEP.KKINS2CSTMMicroT1Ang = Vector()

	SWEP.KKINS2CSTMEoTechXPSPos = Vector( -2.8, -2, -0.2 )
	SWEP.KKINS2CSTMEoTechXPSAng = Vector()

	SWEP.KKINS2CSTMCompM4SPos = Vector( -2.8, -2, -0.2 )
	SWEP.KKINS2CSTMCompM4SAng = Vector()

	SWEP.KKINS2CSTMACOGPos = Vector( -2.8, -3, -0.2 )
	SWEP.KKINS2CSTMACOGAng = Vector()
end

SWEP.MuzzleEffect = "muzzleflash_vollmer"
SWEP.MuzzleEffectWorld = "muzzleflash_vollmer"
...
SWEP.ViewModel		= "models/weapons/cw_cultist/blackout/v_blackout.mdl"
SWEP.WorldModel		= "models/weapons/cw_cultist/blackout/w_blackout.mdl"
...
SWEP.FireSound = "CW_KK_INS2_BLACKOUT_FIRE"
SWEP.FireSoundSuppressed = "CW_KK_INS2_BLACKOUT_FIRE_SUPPRESSED"
SWEP.Recoil = 1.1
