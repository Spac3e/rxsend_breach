...
if CLIENT then
	...
	SWEP.InvIcon = Material( "nextoren/gui/icons/weapons/nv4.png" )
	...
	SWEP.AttachmentModelsVM = {
		["kk_ins2_optic_iron"] = {model = "models/weapons/cw_cultist/nv4/upgrades/a_carryhandle_m4.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, active = true},
	...
	SWEP.AttachmentModelsWM = {
		["kk_ins2_optic_iron"] = {model = "models/weapons/cw_cultist/nv4/upgrades/w_flipup3.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, active = true},
	...
	SWEP.IronsightPos = Vector(-2.4942, -2, 0.5 )
	SWEP.IronsightAng = Vector(-0.3628, 0.0389, 0)

	SWEP.FoldSightPos = Vector(-2.4966, -2, 0.5 )
	SWEP.FoldSightAng = Vector(-1.1876, 0, 0)

	SWEP.M203Pos = Vector(-0.5168, -2, 1.149)
	SWEP.M203Ang = Vector(0.593, -0.0025, 0)

	SWEP.KKINS2KobraPos = Vector(-2.5, -2, 0 )
	SWEP.KKINS2KobraAng = Vector()

	SWEP.KKINS2EoTechPos = Vector(-2.4945, -2, 0.3 )
	SWEP.KKINS2EoTechAng = Vector()

	SWEP.KKINS2AimpointPos = Vector(-2.495, -2, 0.3 )
	SWEP.KKINS2AimpointAng = Vector()

	SWEP.KKINS2ElcanPos = Vector(-2.4903, -3, 0.3 )
	SWEP.KKINS2ElcanAng = Vector()

	SWEP.KKINS2MagnifierPos = Vector(-2.4897, -1, 0.3)
	SWEP.KKINS2MagnifierAng = Vector()

	SWEP.KKINS2CSTMCMorePos = Vector(-2.495, -2, 0.3)
	SWEP.KKINS2CSTMCMoreAng = Vector()

	SWEP.KKINS2CSTMBarskaPos = Vector(-2.4945, -2, 0.25)
	SWEP.KKINS2CSTMBarskaAng = Vector()

	SWEP.KKINS2CSTMMicroT1Pos = Vector(-2.495, -2, 0.25)
	SWEP.KKINS2CSTMMicroT1Ang = Vector()

	SWEP.KKINS2CSTMEoTechXPSPos = Vector(-2.5015, -2, 0.25)
	SWEP.KKINS2CSTMEoTechXPSAng = Vector()

	SWEP.KKINS2CSTMCompM4SPos = Vector(-2.495, -2, 0.25)
	SWEP.KKINS2CSTMCompM4SAng = Vector()

	SWEP.KKINS2CSTMACOGPos = Vector(-2.4903, -3, 0.25)
	SWEP.KKINS2CSTMACOGAng = Vector()
end

SWEP.MuzzleEffect = "blue_weapon_muzzle_flash"
SWEP.MuzzleEffectWorld = "blue_weapon_muzzle_flash"

SWEP.Attachments = {
	{header = "Sight", offset = {500, -500}, atts = { "kk_ins2_kobra", "kk_ins2_eotech", "kk_ins2_aimpoint", "kk_ins2_elcan", "kk_ins2_cstm_cmore", "kk_ins2_cstm_barska", "kk_ins2_cstm_microt1", "kk_ins2_cstm_eotechxps", "kk_ins2_cstm_compm4s", "kk_ins2_cstm_acog"}},
...
SWEP.ViewModel		= "models/weapons/cw_cultist/nv4/v_nv4.mdl"
SWEP.WorldModel		= "models/weapons/cw_cultist/nv4/w_nv4.mdl"
...
SWEP.FireDelay = 0.074
SWEP.FireSound = "CW_KK_INS2_NV4_FIRE"
SWEP.FireSoundSuppressed = "CW_KK_INS2_NV4_FIRE_SUPPRESSED"
SWEP.Recoil = 1.19
