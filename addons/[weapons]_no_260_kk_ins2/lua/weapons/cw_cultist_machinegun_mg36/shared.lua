...
if CLIENT then
	...
	SWEP.InvIcon = Material( "nextoren/gui/icons/weapons/mg36.png" )
...
if CustomizableWeaponry_KK.ins2.ws then
	table.insert(SWEP.Attachments, 3, {header = "Package", offset = {-400, 0}, atts = {"kk_ins2_MG36_sopmod"}})
end
...
SWEP.ViewModel		= "models/weapons/cw_cultist/mg36/v_mg36.mdl"
SWEP.WorldModel		= "models/weapons/cw_cultist/mg36/w_mg36.mdl"
...
SWEP.Primary.DefaultClip = 0 --	= 75
SWEP.Primary.Automatic		= true
SWEP.Primary.Ammo			= "SMG1"
SWEP.MG = true

SWEP.FireDelay = 0.1
SWEP.FireSound = "CW_KK_INS2_MG36_FIRE"
SWEP.FireSoundSuppressed = "CW_KK_INS2_MG36_FIRE_SUPPRESSED"
SWEP.Recoil = 1.2
...
if CLIENT then
	local att = CustomizableWeaponry.registeredAttachmentsSKey["kk_ins2_MG36_sopmod"]
...
if CLIENT then
	...
	CustomizableWeaponry.callbacks:addNew("adjustViewmodelPosition", "KK_INS2_RPK", function(wep, TargetPos, TargetAng)
		...
		if !wep.ActiveAttachments.kk_ins2_MG36_sopmod then return end
