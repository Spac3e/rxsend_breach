...
if CLIENT then
	...
	SWEP.InvIcon = Material( "nextoren/gui/icons/weapons/sg552.png" )
	...
	SWEP.KKINS2KobraPos = Vector(-2.28, -2, 0 )
	SWEP.KKINS2KobraAng = Vector(0, .22, 0)

	SWEP.KKINS2EoTechPos = Vector(-2.28, -2, 0 )
	SWEP.KKINS2EoTechAng = Vector(0, .22, 0)

	SWEP.KKINS2AimpointPos = Vector(-2.33, -2, 0.15 )
	SWEP.KKINS2AimpointAng = Vector(0, .25, 0)

	SWEP.KKINS2ElcanPos = Vector(-2.32, -2, -.15 )
	SWEP.KKINS2ElcanAng = Vector(0, .32, 0)

	SWEP.KKINS2PO4Pos = Vector(-2.28, -2, 0.25 )
	SWEP.KKINS2PO4Ang = Vector(0, .22, .5)

	SWEP.KKINS2MagnifierPos = Vector(-2.32, -2, .2 )
	SWEP.KKINS2MagnifierAng = Vector(0, .33, .4)

	SWEP.KKINS2CSTMBarskaPos = Vector(-2.32, -2, -.1 )
	SWEP.KKINS2CSTMBarskaAng = Vector(0, .25, 0)

	SWEP.KKINS2CSTMCMorePos = Vector(-2.32, -2, 0.15 )
	SWEP.KKINS2CSTMCMoreAng = Vector(0, .25, 0)

	SWEP.KKINS2CSTMEoTechXPSPos = Vector(-2.32, -2, 0.15 )
	SWEP.KKINS2CSTMEoTechXPSAng = Vector(0, .25, 0)
