...
if CLIENT then
	...
	SWEP.PrintName = "DMR 25"
	SWEP.CSMuzzleFlashes = true
	SWEP.ViewModelMovementScale = 1.15
	SWEP.InvIcon = Material( "nextoren/gui/icons/weapons/dmr25.png" )
	...
	SWEP.IronsightPos = Vector(-2.5, -2, 0.6 )
...
SWEP.ViewModel		= "models/weapons/cw_cultist/dmr25/v_dmr25.mdl"
SWEP.WorldModel		= "models/weapons/cw_cultist/dmr25/w_dmr25.mdl"
