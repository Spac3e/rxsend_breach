...
SWEP.Sounds = {
	...
	base_reload = {
		{time = 12/30, sound = "CW_KK_INS2_M14_MAGRELEASE"},
		{time = 16/30, sound = "CW_KK_INS2_M14_MAGOUT"},
		{time = 56/30, sound = "CW_KK_INS2_M14_MAGIN"},
		{time = 74/30, sound = "CW_KK_INS2_AKM_MAGIN"},
	},

	base_reloadempty = {
		{time = 6/30, sound = "CW_KK_INS2_M14_MAGRELEASE"},
