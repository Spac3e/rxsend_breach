...
if CLIENT then
	...
	SWEP.InvIcon = Material( "nextoren/gui/icons/weapons/fate.png" )
	...
	SWEP.AttachmentModelsVM = {
		["kk_ins2_optic_iron"] = {model = "models/weapons/cw_cultist/fate/upgrades/a_standard_fal.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, active = true},
		["kk_ins2_optic_rail"] = {model = "models/weapons/cw_cultist/fate/upgrades/a_modkit_fal.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},
		...
		["kk_ins2_bipod"] = {model = "models/weapons/cw_cultist/fate/upgrades/a_bipod_fal.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},
		...
		["kk_ins2_FATE_skin"] = {model = "models/weapons/v_fal.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, hideVM = true, material = "models/weapons/fal/blvck.mdl"},
		["kk_ins2_FATE_skin2"] = {model = "models/weapons/v_fal.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, hideVM = true, material = "models/weapons/fal/dosh.mdl"},
	}


	SWEP.IronsightPos = Vector(-3.26, -4.2, 0.65 )
...
SWEP.Attachments = {
	...
	{header = "Flavor", offset = {450, 500}, atts = {"kk_ins2_FATE_skin", "kk_ins2_FATE_skin2"}},
...
SWEP.ViewModel		= "models/weapons/cw_cultist/fate/v_fate.mdl"
SWEP.WorldModel		= "models/weapons/cw_cultist/fate/w_fate.mdl"
...
SWEP.FireDelay = 0.1
SWEP.FireSound = "CW_KK_INS2_FATE_FIRE"
SWEP.FireSoundSuppressed = "CW_KK_INS2_FATE_FIRE_SUPPRESSED"
SWEP.Recoil = 1.1
...
if CLIENT then
	...
	CustomizableWeaponry_KK.ins2.welementThink:add("cw_kk_ins2_fnfal", function(wep, welement)
		if wep.ActiveAttachments.kk_ins2_FATE_skin then
			if worldFals[wep] != 1 then
				welement:SetSubMaterial(0, "models/weapons/fal/w_blvck.mdl")
				worldFals[wep] = 1
			end
		elseif wep.ActiveAttachments.kk_ins2_FATE_skin2 then
