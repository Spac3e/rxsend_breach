...
if CLIENT then
	...
	SWEP.InvIcon = Material( "nextoren/gui/icons/weapons/pecheneg.png" )
...
SWEP.ViewModel		= "models/weapons/cw_cultist/pecheneg/v_pecheneg.mdl"
SWEP.WorldModel		= "models/weapons/cw_cultist/pecheneg/w_pecheneg.mdl"
...
SWEP.FireDelay = 110/800
SWEP.FireSound = "CW_KK_INS2_PECH_FIRE"
