--[[
lua/weapons/cw_kk_ins2_ump45/shared.lua
--]]
...
if CLIENT then
	...
	SWEP.InvIcon = Material( "nextoren/gui/icons/weapons/ump45.png" )

	SWEP.SelectIcon = surface.GetTextureID("vgui/entities/ump45")
