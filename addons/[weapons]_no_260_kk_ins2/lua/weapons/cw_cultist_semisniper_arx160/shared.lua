...
if CLIENT then
	...
	SWEP.InvIcon = Material( "nextoren/gui/icons/weapons/arx.png" )
	...
	SWEP.AttachmentModelsVM = {
		["kk_ins2_optic_iron"] = {model = "models/weapons/cw_cultist/arx/upgrades/a_standard_mk18.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, active = true},

		["cover_long"] = {model = "models/weapons/cw_cultist/arx/upgrades/a_standard2_mk18.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, active = true},
		["cover_short"] = {model = "models/weapons/cw_cultist/arx/upgrades/a_standard3_mk18.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},
	...
	SWEP.IronsightPos = Vector(-2.75, -2, 0.7535)
	SWEP.IronsightAng = Vector(0.1915, 0.0105, 0)

	SWEP.KKINS2KobraPos = Vector(-2.75, -2, 0.6936)
	SWEP.KKINS2KobraAng = Vector()

	SWEP.KKINS2EoTechPos = Vector(-2.75, -2, 0.5236)
	SWEP.KKINS2EoTechAng = Vector()

	SWEP.KKINS2AimpointPos = Vector(-2.75, -2, 0.7597)
	SWEP.KKINS2AimpointAng = Vector()

	SWEP.KKINS2ElcanPos = Vector(-2.75, -1, 0.4252)
	SWEP.KKINS2ElcanAng = Vector()

	SWEP.KKINS2PO4Pos = Vector(-2.75, -2, 0.8519)
	SWEP.KKINS2PO4Ang = Vector()

	SWEP.KKINS2MagnifierPos = Vector(-2.75, -1, 0.7475)
	SWEP.KKINS2MagnifierAng = Vector()

	SWEP.KKINS2CSTMEoTechXPSPos = Vector(-2.75, -2, 0.7597)
...
SWEP.ViewModel		= "models/weapons/cw_cultist/arx/v_arx.mdl"
SWEP.WorldModel		= "models/weapons/cw_cultist/arx/w_arx.mdl"
