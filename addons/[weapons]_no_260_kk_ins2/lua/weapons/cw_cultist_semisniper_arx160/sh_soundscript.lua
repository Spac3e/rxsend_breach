...
SWEP.Sounds = {
	base_ready = {
		...
		{time = 16/32, sound = "CW_KK_INS2_MK18_BOLTBACK"},
		{time = 26/32, sound = "CW_KK_INS2_MK18_BOLTRELEASE"},
	...
	base_reload = {
		{time = 36/30, sound = "CW_KK_INS2_MK18_MAGRELEASE"},
		{time = 38/30, sound = "CW_KK_INS2_MK18_MAGOUT"},
		{time = 64/30, sound = "CW_KK_INS2_MK18_MAGIN"},
	},

	base_reloadempty = {
		{time = 13/30, sound = "CW_KK_INS2_MK18_MAGRELEASE"},
		{time = 17/30, sound = "CW_KK_INS2_MK18_MAGOUT"},
		{time = 60/30, sound = "CW_KK_INS2_MK18_MAGIN"},
		{time = 74/30, sound = "CW_KK_INS2_MK18_HIT"},
		{time = 87/30, sound = "CW_KK_INS2_MK18_BOLTRELEASE"},
	},
