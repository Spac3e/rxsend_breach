...
if CLIENT then
	...
	SWEP.InvIcon = Material( "nextoren/gui/icons/weapons/msr.png" )
	...
	SWEP.AttachmentModelsVM = {
		...
		["kk_ins2_bipod"] = {model = "models/weapons/cw_cultist/msr/upgrades/a_bipod_m40.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},
		...
		["kk_ins2_scope_m40"] = {model = "models/weapons/cw_cultist/msr/upgrades/a_optic_m40.mdl", rLight = true, pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},
	...
	SWEP.AttachmentModelsWM = {
		...
		["kk_ins2_bipod"] = {model = "models/weapons/cw_cultist/msr/upgrades/w_bipod_m40.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},
		...
		["kk_ins2_scope_m40"] = {model = "models/weapons/cw_cultist/msr/upgrades/w_scope_m40.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},
...
SWEP.ViewModel		= "models/weapons/cw_cultist/msr/v_msr.mdl"
SWEP.WorldModel		= "models/weapons/cw_cultist/msr/w_msr.mdl"
