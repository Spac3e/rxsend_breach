...
if CLIENT then
	...
	SWEP.InvIcon = Material( "nextoren/gui/icons/weapons/hbz.png" )
	...
	SWEP.AttachmentModelsVM = {
		...
		["cover_long"] = {model = "models/weapons/cw_cultist/qbz/upgrades/a_standard2_mk18.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, active = true},
		["cover_short"] = {model = "models/weapons/cw_cultist/qbz/upgrades/a_standard3_mk18.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},
	...
	SWEP.IronsightPos = Vector(-2.6, -2, -0.5)
	SWEP.IronsightAng = Vector(0.1915, 0.0105, 0)

	SWEP.KKINS2KobraPos = Vector(-2.6, -2, -1.5)
	SWEP.KKINS2KobraAng = Vector()

	SWEP.KKINS2EoTechPos = Vector(-2.6, -2, -1.6)
	SWEP.KKINS2EoTechAng = Vector()

	SWEP.KKINS2AimpointPos = Vector(-2.6, -2, -1.48)
	SWEP.KKINS2AimpointAng = Vector()

	SWEP.KKINS2ElcanPos = Vector(-2.6, -2, -1.65)
	SWEP.KKINS2ElcanAng = Vector()

	SWEP.KKINS2PO4Pos = Vector(-2.5, -2, -1.25)
	SWEP.KKINS2PO4Ang = Vector()

	SWEP.KKINS2MagnifierPos = Vector(-2.5, -2, -1.5)
	SWEP.KKINS2MagnifierAng = Vector()

	SWEP.KKINS2CSTMEoTechXPSPos = Vector(-2.6, -2, -1.5)
	SWEP.KKINS2CSTMEoTechXPSAng = Vector()

	SWEP.KKINS2CSTMCMorePos =  Vector(-2.6, -2, -1.48)
...
SWEP.ViewModel		= "models/weapons/cw_cultist/qbz/v_qbz.mdl"
SWEP.WorldModel		= "models/weapons/cw_cultist/qbz/w_qbz.mdl"
