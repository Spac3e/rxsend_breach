...
function SWEP:CalcView(ply, pos, ang, fov)
	...
	if self.holdingBreath then
		if self.AimViewModelFOV >= 30 then
			self.BreathFOVModifier = math.Approach(self.BreathFOVModifier, 30, FT * 120)
		else
			self.BreathFOVModifier = math.Approach(self.BreathFOVModifier, 5, FT * 15)
		end
	else
		self.BreathFOVModifier = math.Approach(self.BreathFOVModifier, 0, FT * 120)
	end
