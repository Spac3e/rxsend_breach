...
CW_ALTERNATIVE_MUZZLEFLASH_1P = {
	...
	["muzzleflash_pistol_npc"] = "muzzleflash_m9_1p_core",
	["muzzleflash_shotgun"] = "muzzleflash_toz_1p_core",
	["muzzleflash_pistol_red"] = "muzzleflash_ak74_1p_core",
	["weapon_muzzle_flash_smg"] = "muzzleflash_ak74_1p_core"
}

CW_ALTERNATIVE_MUZZLEFLASH_3P = {
	["muzzleflash_vollmer"] = "muzzleflash_m16_3rd",
	["muzzleflash_smg_npc"] = "muzzleflash_ump_3rd",
	["muzzleflash_6"] = "muzzleflash_m16_3rd",
	["muzzleflash_pistol_npc"] = "muzzleflash_m9_3rd",
	["muzzleflash_shotgun"] = "muzzleflash_toz_3rd",
	["muzzleflash_pistol_red"] = "muzzleflash_ak74_3rd",
	["weapon_muzzle_flash_smg"] = "muzzleflash_ak74_3rd"
}

for k, v in ipairs(table.GetKeys(CW_ALTERNATIVE_MUZZLEFLASH_1P)) do
	PrecacheParticleSystem(CW_ALTERNATIVE_MUZZLEFLASH_1P[v])
end

for k, v in ipairs(table.GetKeys(CW_ALTERNATIVE_MUZZLEFLASH_3P)) do
	PrecacheParticleSystem(CW_ALTERNATIVE_MUZZLEFLASH_3P[v])
end
...
if CLIENT then
	...
	SWEP.AimSwayIntensity = 0.7
	SWEP.ZoomAmount = 0
	SWEP.FOVPerShot = 0

	SWEP.SprintAnimSpeed = 1.1
	SWEP.ViewModelMovementScale_sprint = 2
	SWEP.ViewModelMovementScale_base = -1

	SWEP.CW_KK_HANDS_MDL = "models/weapons/v_cw_kk_ins2_hands_css.mdl"
...
function SWEP:IndividualThink()
	...
	selftable.lastOwner = owner

	self:IndividualThink_INS2()

	entdrawshadow(self, false)
	...
	if CLIENT then
		selftable.ViewModelMovementScale = self:scaleMovement(1, 1)

		fa = cvarFA:GetInt()
		fa = (fa == 1) and cvarFAAC:SetInt(fa)
		-- selftable.NoFreeAim = self:isAiming()

		shouldDrawCrosshair = owner:ShouldDrawLocalPlayer()
		selftable.CrosshairEnabled = shouldDrawCrosshair
		selftable.FadeCrosshairOnAim = !shouldDrawCrosshair

		-- if selftable.AttachmentModelsVM.kk_ins2_ww2_knife then
			-- selftable.DisableSprintViewSimulation = selftable.ActiveAttachments.kk_ins2_ww2_knife
		-- end
