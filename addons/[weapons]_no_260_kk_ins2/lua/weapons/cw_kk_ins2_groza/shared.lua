...
if CLIENT then
	...
	SWEP.InvIcon = Material( "nextoren/gui/icons/weapons/groza.png" )
	...
	SWEP.AttachmentModelsVM = {
		["kk_ins2_optic_rail"] = {model = "models/weapons/cw_cultist/groza/upgrades/upgrades/a_modkit_07.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},
		["handguardStandard"] = {model = "models/weapons/cw_cultist/groza/upgrades/a_standard_aks74u.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, active = true},

		["kk_ins2_pbs5"] = {model = "models/weapons/cw_cultist/groza/upgrades/a_suppressor_aks.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},

		["kk_ins2_vertgrip"] = {model = "models/weapons/cw_cultist/groza/upgrades/a_woodgrips_aks74u.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},
	...
	SWEP.AttachmentModelsWM = {
		["kk_ins2_optic_rail"] = {model = "models/weapons/cw_cultist/groza/upgrades/w_modkit_7.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},
		["handguardStandard"] = {model = "models/weapons/cw_cultist/groza/upgrades/w_standard_aks74u.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, active = true},

		["kk_ins2_pbs5"] = {model = "models/weapons/upgrades/w_sil_ins1.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},

		["kk_ins2_vertgrip"] = {model = "models/weapons/cw_cultist/groza/upgrades/w_foregrip_aks74u.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},
	...
	SWEP.IronsightPos = Vector(-2.84, 0, 0.68)
	SWEP.IronsightAng = Vector()

	SWEP.KKINS2KobraPos = Vector(-2.84, 0, -0.85)
	SWEP.KKINS2KobraAng = Vector()

	SWEP.KKINS2EoTechPos = Vector(-2.84, 0, -0.85)
	SWEP.KKINS2EoTechAng = Vector()

	SWEP.KKINS2AimpointPos = Vector(-2.84, 0, -0.85)
	SWEP.KKINS2AimpointAng = Vector()

	SWEP.KKINS2ElcanPos = Vector(-2.84, 0, -0.85)
	SWEP.KKINS2ElcanAng = Vector()

	SWEP.KKINS2PO4Pos = Vector(-2.84, 0, -0.65)
	SWEP.KKINS2PO4Ang = Vector()

	SWEP.KKINS2MagnifierPos = Vector(-2.84, 0, -0.85)
...
SWEP.ViewModel		= "models/weapons/cw_cultist/groza/v_groza.mdl"
SWEP.WorldModel		= "models/weapons/cw_cultist/groza/w_groza.mdl"
