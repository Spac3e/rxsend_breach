--[[
lua/weapons/cw_kk_ins2_m40a1/shared.lua
--]]
...
if CLIENT then
	...
	SWEP.SelectIcon = surface.GetTextureID("vgui/entities/m40a1")
	SWEP.InvIcon = Material( "nextoren/gui/icons/weapons/m40.png" )
