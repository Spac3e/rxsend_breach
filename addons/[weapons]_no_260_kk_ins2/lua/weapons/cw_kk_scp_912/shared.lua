--[[
lua/weapons/cw_kk_ins2_m4a1/shared.lua
--]]
...
if CLIENT then
	...
	SWEP.SelectIcon = surface.GetTextureID("vgui/entities/m4a1")
...
SWEP.Slot = 3
SWEP.SlotPos = 0
SWEP.NormalHoldType = "scp912"
SWEP.RunHoldType = "scp912"
