--[[
lua/weapons/cw_kk_ins2_arse_g18/shared.lua
--]]
...
if CLIENT then
	...
	SWEP.InvIcon = Material( "nextoren/gui/icons/weapons/glock18.png" )

	SWEP.SelectIcon = surface.GetTextureID("vgui/entities/g18")
