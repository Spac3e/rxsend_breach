...
if CLIENT then
	...
	SWEP.PrintName = "Imbel"
	SWEP.CSMuzzleFlashes = true
	SWEP.InvIcon = Material( "nextoren/gui/icons/weapons/imbel.png" )
	...
	SWEP.AttachmentModelsVM = {
		["kk_ins2_optic_iron"] = {model = "models/weapons/cw_cultist/imbel/upgrades/a_standard_mk18.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, active = true},

		["cover_long"] = {model = "models/weapons/cw_cultist/imbel/upgrades/a_standard2_mk18.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, active = true},
		["cover_short"] = {model = "models/weapons/cw_cultist/imbel/upgrades/a_standard3_mk18.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},
	...
	SWEP.AttachmentModelsWM = {
		["kk_ins2_optic_iron"] = {model = "models/weapons/cw_cultist/imbel/upgrades/w_flipup2.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, active = true},
	...
	SWEP.IronsightPos = Vector(-2.481, 0, 0.239)
	SWEP.IronsightAng = Vector()

	SWEP.KKINS2KobraPos = Vector(-2.481, 0, -0.65)
	SWEP.KKINS2KobraAng = Vector()

	SWEP.KKINS2EoTechPos = Vector(-2.481, 0, -0.75)
	SWEP.KKINS2EoTechAng = Vector()

	SWEP.KKINS2AimpointPos = Vector(-2.481, 0, -0.5)
	SWEP.KKINS2AimpointAng = Vector()

	SWEP.KKINS2ElcanPos = Vector(-2.481, 0, -0.85)
	SWEP.KKINS2ElcanAng = Vector()

	SWEP.KKINS2PO4Pos = Vector(-2.481, 0, -0.45)
	SWEP.KKINS2PO4Ang = Vector()

	SWEP.KKINS2MagnifierPos = Vector(-2.481, 0, -0.5)
...
SWEP.ViewModel		= "models/weapons/cw_cultist/imbel/v_imbel.mdl"
SWEP.WorldModel		= "models/weapons/cw_cultist/imbel/w_imbel.mdl"
...
SWEP.Primary.DefaultClip = 0 --	= 30
SWEP.Primary.Automatic		= true
SWEP.Primary.Ammo			= "AR2"

SWEP.FireDelay = 0.066666666666667
SWEP.FireSound = "CW_KK_INS2_IMBEL_FIRE"
SWEP.FireSoundSuppressed = "CW_KK_INS2_IMBEL_FIRE_SUPPRESSED"
SWEP.Recoil = 1.1025
