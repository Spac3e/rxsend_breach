...
if CLIENT then
	...
	SWEP.InvIcon = Material( "nextoren/gui/icons/weapons/usr.png" )
	...
	SWEP.AttachmentModelsVM = {
		["kk_ins2_optic_iron"] = {model = "models/weapons/cw_cultist/usr/upgrades/a_standard_m40.mdl", pos = Vector(), angle = Angle(90, 90, 0), size = Vector(1, 1, 1), merge = true, active = true},
	...
	SWEP.IronsightPos = Vector(-2.84, -1, -0.2)
...
SWEP.ViewModel		= "models/weapons/cw_cultist/usr/v_usr.mdl"
SWEP.WorldModel		= "models/weapons/cw_cultist/usr/w_usr.mdl"
