...
if CLIENT then
	...
	SWEP.PrintName = "JRD90"
	SWEP.CSMuzzleFlashes = true
	SWEP.InvIcon = Material( "nextoren/gui/icons/weapons/jrd90.png" )
	...
	SWEP.AttachmentModelsVM = {
		["kk_ins2_optic_iron"] = {model = "models/weapons/cw_cultist/jrd90/upgrades/a_standard_m40.mdl", pos = Vector(), angle = Angle(90, 90, 0), size = Vector(1, 1, 1), merge = true, active = true},
	...
	SWEP.IronsightPos = Vector( -2.815, -3, 0 )
	SWEP.IronsightAng = Vector( -0.03, 0.03, 0 )

	SWEP.KKINS2KobraPos = Vector( -2.815, -2, -0.7 )
	SWEP.KKINS2KobraAng = Vector()

	SWEP.KKINS2EoTechPos = Vector( -2.815, -2, -0.6 )
	SWEP.KKINS2EoTechAng = Vector()

	SWEP.KKINS2AimpointPos = Vector( -2.815, -2, -0.6 )
	SWEP.KKINS2AimpointAng = Vector()

	SWEP.KKINS2ElcanPos = Vector( -2.815, -3, -0.6 )
	SWEP.KKINS2ElcanAng = Vector()

	SWEP.KKINS2PO4Pos = Vector( -2.815, -4, -0.6 )
	SWEP.KKINS2PO4Ang = Vector()

	SWEP.KKINS2ScopeM40Pos = Vector( -2.815, -1, -0.6 )
...
SWEP.ViewModel		= "models/weapons/cw_cultist/jrd90/v_jrd90.mdl"
SWEP.WorldModel		= "models/weapons/cw_cultist/jrd90/w_jrd90.mdl"
...
SWEP.FireDelay = 0.3
SWEP.FireSound = "CW_KK_INS2_JRD90_FIRE"
SWEP.FireSoundSuppressed = "CW_KK_INS2_JRD90_FIRE_SUPPRESSED"
SWEP.Recoil = 2.5
