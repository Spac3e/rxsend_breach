...
if CLIENT then
	...
	SWEP.PrintName = "SQ300"
	SWEP.CSMuzzleFlashes = true
	SWEP.ViewModelMovementScale = 1.15
	SWEP.InvIcon = Material( "nextoren/gui/icons/weapons/sq300.png" )
	...
	SWEP.AttachmentModelsVM = {
		["kk_ins2_optic_iron"] = {model = "models/weapons/cw_cultist/sq300/upgrades/a_standard_mk18.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, active = true},

		["cover_long"] = {model = "models/weapons/cw_cultist/sq300/upgrades/a_standard2_mk18.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, active = true},
		["cover_short"] = {model = "models/weapons/cw_cultist/sq300/upgrades/a_standard3_mk18.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},

		["kk_ins2_suppressor_sec"] = {model = "models/weapons/cw_cultist/sq300/upgrades/a_suppressor_sec2.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},
	...
	SWEP.IronsightPos = Vector(-2.6, -2, -0.4)
	SWEP.IronsightAng = Vector(0.1915, 0.0105, 0)

	SWEP.KKINS2KobraPos = Vector(-2.53, -2, -0.6)
	SWEP.KKINS2KobraAng = Vector()

	SWEP.KKINS2EoTechPos = Vector(-2.5456, -2, -0.6)
	SWEP.KKINS2EoTechAng = Vector()

	SWEP.KKINS2AimpointPos = Vector(-2.5439, -2, -.55)
	SWEP.KKINS2AimpointAng = Vector()

	SWEP.KKINS2ElcanPos = Vector(-2.5356, -1, -.55)
	SWEP.KKINS2ElcanAng = Vector()

	SWEP.KKINS2PO4Pos = Vector(-2.4764, -2, -.55)
	SWEP.KKINS2PO4Ang = Vector()

	SWEP.KKINS2MagnifierPos = Vector(-2.5328, -1, -.55)
	SWEP.KKINS2MagnifierAng = Vector()

	SWEP.KKINS2CSTMEoTechXPSPos = Vector(-2.5439, -2, -.55)
...
SWEP.ViewModel		= "models/weapons/cw_cultist/sq300/v_sq300.mdl"
SWEP.WorldModel		= "models/weapons/cw_cultist/sq300/w_sq300.mdl"
