--[[
lua/weapons/cw_kk_ins2_nade_anm14/shared.lua
--]]
...
if CLIENT then
	...
	SWEP.SelectIcon = surface.GetTextureID("vgui/entities/anm14")
	SWEP.InvIcon = Material( "nextoren/gui/icons/weapons/anm14.png" )
